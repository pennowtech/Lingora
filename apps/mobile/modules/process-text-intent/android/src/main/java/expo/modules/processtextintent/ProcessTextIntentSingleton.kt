 ...
 * start case (user long-presses text in another app, taps "Search in Lemory" in the selection
 * toolbar, and Lemory wasn't already running). `ProcessTextIntentReactActivityLifecycleListener`
