...
const HELP_SECTIONS: HelpSection[] = [
  {
    ...
    icon: 'ShieldCheck',
    paragraphs: [
      'Lemmory is built **offline-first**. All your cards, review history, and learning progress stay strictly on your device unless you enable optional Cloud Sync.',
