export const ENGLISH_PHRASES = [
  ...
  "Search word, lemma, or context...",
  "Mine Sentence",
  "Sync Active",
  "Search a word and add to deck",
  "Review your deck",
  "Saved across all decks",
  "Mined Sentences",
  "{{count}} Pending",
  ...
  "Good evening!",
  "Nice to see you back.",
  "Start Review ({{count}} Due)",
  "{{count}} cards · {{retention}}% retention",
  "{{count}} cards due for review right now.",
  "Open Statistics",
  "Loading statistics...",
  "Failed to load statistics: {{error}}",
  "Learning Statistics",
  "Retention, review activity, vocabulary growth, and the words giving you the most trouble.",
  "Retention (30d)",
  "Remembered on first review",
  "Day Streak",
