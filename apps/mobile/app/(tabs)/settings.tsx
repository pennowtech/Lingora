...
const SEARCHABLE_SETTINGS: SearchableSetting[] = [
  ...
  { key: 'about', label: 'About Lemory', group: 'System & Account', keywords: ['version', 'info', 'whats new', 'changelog', 'release', 'github'], route: '/settings/about', icon: 'Info' },
]
      ...
      {searchResults ? (
        ...
        <>
          ...
          <View style={styles.footer}>
            ...
            <Text style={styles.footerText}>{t('Lemory')}</Text>
          </View>
        </>
      )}
    </ScrollView>
