...
Das **Home Dashboard** ist der tägliche Ausgangspunkt in Lemmory. Es bietet Ihnen einen Echtzeitüberblick über Ihre Wiederholungslast bei räumlichen Wiederholungen, die aktuelle Lernserie, die kuratierte Wort-des-Tages-Entdeckung und sofortige Verknüpfungen zur Wörterbuchsuche und zum Satz-Mining.
...
- **Was ist neu Modal**: Wird automatisch einmal pro Version angezeigt, wenn eine neue Version von Lemmory gestartet wird, und fasst neu eingeführte Funktionen zusammen.
