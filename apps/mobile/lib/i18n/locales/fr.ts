...
Home: 'Accueil',
  ...
  'Restore from Lemory backup (.lem)': 'Restaurer depuis une sauvegarde Lemory (.lem)',
  ...
  'Lemory backup (.lem)': 'Sauvegarde Lemory (.lem)',
  ...
  "Study your Lemory vocabulary in Anki/AnkiDroid. Cards start fresh - review history isn't carried over.":
    "Étudiez votre vocabulaire Lemory dans Anki/AnkiDroid. Les cartes repartent à zéro - l'historique de révision n'est pas transféré.",
  ...
  'Choose a Lemory `.lem` file - a deck someone shared with you, or one of your own deck exports. Full fidelity: meanings, examples, synonyms, cloze cards, review history, and FSRS scheduling all come across.':
    "Choisissez un fichier Lemory `.lem` - un paquet que quelqu'un a partagé avec vous, ou l'un de vos propres exports de paquet. Fidélité totale : sens, exemples, synonymes, cartes lacunaires, historique de révision et planification FSRS sont tous transférés.",
  ...
  'Add to Lemory': 'Ajouter à Lemory',
  ...
  "Found a sentence somewhere else, like an article or a message? Share it to Lemory the same way you'd share it to any other app.":
    "Tu as trouvé une phrase ailleurs, comme dans un article ou un message ? Partage-la vers Lemory comme tu le ferais vers n'importe quelle autre app.",
  ...
  'Long-press a word in any app and pick "Search in Lemory" to look it up here right away.':
    "Fais un appui long sur un mot dans n'importe quelle app et choisis « Rechercher dans Lemory » pour le chercher ici directement.",
  'Long-press a word in any app - your browser, messages, anywhere - and pick "Search in Lemory." It opens right here with that word ready to go.':
    "Fais un appui long sur un mot dans n'importe quelle app - ton navigateur, tes messages, n'importe où - et choisis « Rechercher dans Lemory ». Ça s'ouvre directement ici avec ce mot prêt à l'emploi.",
  Markdown: 'Markdown',
  Message: 'Message',
  ...
  "Submitting posts your message as a GitHub issue on Lemory's public repository - anyone can read it, including your contact email if you provide one.":
    "Envoyer publie ton message comme issue GitHub sur le dépôt public de Lemory - n'importe qui peut le lire, y compris ton e-mail de contact si tu en fournis un.",
  ...
  "You can also share text from another app straight to Lemory, the same way you'd share a link or a photo.":
    'Tu peux aussi partager du texte depuis une autre app directement vers Lemory, comme tu partagerais un lien ou une photo.',
  "You can also share text to Lemory, the same way you'd share a link or a photo to any other app.":
    "Tu peux aussi partager du texte vers Lemory, comme tu partagerais un lien ou une photo vers n'importe quelle autre app.",
  ...
  "{{language}} isn't ready yet - English and German are the only languages Lemory fully supports right now.":
    "{{language}} n'est pas encore prêt - l'anglais et l'allemand sont les seules langues entièrement prises en charge par Lemory pour l'instant.",
  ...
  "Signing in with Google links this device to a private cloud copy of your decks, cards, and review progress - so if you get a new phone, or use Lemory on two devices, you're not starting from zero on the second one.":
    'Se connecter avec Google relie cet appareil à une copie cloud privée de tes decks, cartes et progression - donc si tu changes de téléphone, ou utilises Lemory sur deux appareils, tu ne repars pas de zéro sur le second.',
  ...
  'When this is on, Lemory quietly syncs in the background whenever you leave the app - no need to remember to tap "Sync now" yourself.':
    "Une fois activé, Lemory se synchronise discrètement en arrière-plan dès que tu quittes l'app - plus besoin de penser à toucher « Synchroniser maintenant » toi-même.",
  ...
  'It permanently erases everything this account ever synced to the cloud, disconnects the Google account from Lemory, and signs you out.':
    'Ça efface définitivement tout ce que ce compte a jamais synchronisé dans le cloud, déconnecte le compte Google de Lemory, et te déconnecte.',
