...
/**
 * Bridges Android's "Process Text" intent — the entry Lemory adds to the system text-selection
 * toolbar (long-press a word in any app -> "Search in Lemory") — into JS. See
 ...
 *  - Cold start (Lemory wasn't running): MainActivity's own `onCreate` receives it, captured by
