      ...
      {step === 'pick' ? (
        <Card style={styles.card}>
          ...
          <Text style={styles.body}>
            {t('Choose a Lemory `.lem` file - a deck someone shared with you, or one of your own deck exports. Full fidelity: meanings, examples, synonyms, cloze cards, review history, and FSRS scheduling all come across.')}
          </Text>
