...
/**
 * Android's "Process Text" intent — the entry Lemmory adds to the system text-selection toolbar
 * (long-press a word in any app -> a "Search in Lemmory" option appears next to Copy/Web search).
