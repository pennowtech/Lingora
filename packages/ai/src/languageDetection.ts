...
/**
 * Callers only ever care about two configured languages (native/target) — but a dictionary's
 ...
 * lookup fail outright. Since a search screen is overwhelmingly used to look up target-language
