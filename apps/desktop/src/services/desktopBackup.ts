 ...
 * createDeckBackup — and saves it via desktopFileStorage (a native "Save As" dialog). '.lin' - the
 * Lemmory backup format's own extension, still plain JSON underneath (see createBackup's own doc
