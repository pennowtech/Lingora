...
export default function ImportExportScreen(): JSX.Element {
  ...
  const runFormatExport = (format: ExportFormat, fileName: string): void => {
    ...
    runExport(db, format, { deckName: 'Lemony vocabulary', fileName })
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.scroll}>
      ...
      <OptionAccordion
        ...
        iconBg={colors.primarySoft}
        iconColor={colors.primary}
        title={t('Restore from Lemony backup (.lem)')}
      ...
      <OptionAccordion
        ...
        iconColor={colors.info}
        title={t('Anki deck (.apkg)')}
        detail={t("Study your Lemony vocabulary in Anki/AnkiDroid. Cards start fresh - review history isn't carried over.")}
      ...
      <ExportNameModal
        ...
        defaultName={defaultExportFileName('Lemony vocabulary')}
