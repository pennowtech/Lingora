...
Home: 'होम',
  ...
  'No decks for {{native}} to {{target}}': '{{native}} से {{target}} के लिए कोई डेक नहीं',
  'You have decks in other language pairs. Switch pair in Settings to see them, or create a new one here.':
    'आपके पास अन्य भाषा जोड़ियों में डेक हैं। उन्हें देखने के लिए सेटिंग्स में भाषा जोड़ी बदलें, या यहाँ एक नया बनाएं।',
  'Switch language pair': 'भाषा जोड़ी बदलें',
  'New deck': 'नया डेक',
  ...
  'Look up any {{target}} or {{native}} word instantly. If it\'s not in your library yet, one tap **generates a full flashcard**.':
    'किसी भी {{target}} या {{native}} शब्द को तुरंत खोजें। क्या यह अभी आपकी लाइब्रेरी में नहीं है? एक टैप में **पूरा फ्लैशकार्ड बनाएं**।',
  ...
  // ── apps/desktop - Sidebar, Header, Dashboard, Stats ────────────────────
  'Today': 'आज',
  'Dashboard': 'डैशबोर्ड',
  'Search & Lookup': 'खोज और नज़र',
  'Review Session': 'रिव्यू सेशन',
  'Sentence Mining': 'वाक्य माइनिंग',
  'Analytics': 'आंकड़े',
  '{{count}} Day Streak': '{{count}} दिन की लगातार पढ़ाई',
  '{{count}} cards due today': 'आज {{count}} कार्ड ड्यू हैं',
  'Search word, lemma, or context...': 'शब्द, मूल रूप या संदर्भ खोजें...',
  'Mine Sentence': 'वाक्य माइन करें',
  'Sync Active': 'सिंक सक्रिय',
  'Search a word and add to deck': 'एक शब्द खोजें और डेक में जोड़ें',
  'Review your deck': 'अपने डेक की समीक्षा करें',
  'Saved across all decks': 'सभी डेक में सेव किए गए',
  'Mined Sentences': 'माइन किए गए वाक्य',
  '{{count}} Pending': '{{count}} लंबित',
  'Ready for AI generation': 'AI जनरेशन के लिए तैयार',
  'This Week\'s Practice': 'इस हफ़्ते का अभ्यास',
  'Words reviewed per day, last 7 days': 'पिछले 7 दिनों में प्रतिदिन दोहराए गए शब्द',
  'Difficult Words': 'मुश्किल शब्द',
  'Active Study Decks': 'सक्रिय स्टडी डेक',
  'View All': 'सभी देखें',
  'Study': 'पढ़ें',
  'Recently Searched': 'हाल ही में खोजे गए',
  'Words you look up will show up here.': 'आपके खोजे गए शब्द यहाँ दिखेंगे।',
  'Good morning!': 'सुप्रभात!',
  'Good afternoon!': 'नमस्कार!',
  'Good evening!': 'शुभ संध्या!',
  'Nice to see you back.': 'आपको वापस देखकर अच्छा लगा।',
  'Start Review ({{count}} Due)': 'रिव्यू शुरू करें ({{count}} ड्यू)',
  '{{count}} cards · {{retention}}% retention': '{{count}} कार्ड · {{retention}}% रिटेंशन',
  '{{count}} cards due for review right now.': 'अभी {{count}} कार्ड रिव्यू के लिए ड्यू हैं।',
  'Open Statistics': 'आंकड़े खोलें',
  'Loading statistics...': 'आंकड़े लोड हो रहे हैं...',
  'Failed to load statistics: {{error}}': 'आंकड़े लोड नहीं हो सके: {{error}}',
  'Learning Statistics': 'लर्निंग आंकड़े',
  'Retention, review activity, vocabulary growth, and the words giving you the most trouble.': 'रिटेंशन, रिव्यू गतिविधि, शब्दावली वृद्धि, और वे शब्द जो आपको सबसे ज़्यादा परेशान करते हैं।',
  'Retention (30d)': 'रिटेंशन (30 दिन)',
  'Remembered on first review': 'पहली बार में याद रहा',
  'Day Streak': 'दिन की लगातार पढ़ाई',
  'Consecutive study days': 'लगातार पढ़ाई के दिन',
  'New This Week': 'इस हफ़्ते नए',
  'Words added in the last 7 days': 'पिछले 7 दिनों में जोड़े गए शब्द',
  'Review Activity': 'रिव्यू गतिविधि',
  'Last 5 Weeks': 'पिछले 5 हफ़्ते',
  'Less': 'कम',
  'More': 'ज़्यादा',
  'Upcoming Review Forecast': 'आगामी रिव्यू पूर्वानुमान',
  'Projected due cards for the next 7 days': 'अगले 7 दिनों के लिए अनुमानित ड्यू कार्ड',
  'Vocabulary Growth': 'शब्दावली वृद्धि',
  'New words per week': 'प्रति सप्ताह नए शब्द',
  'Practice': 'अभ्यास करें',
  'Replay introduction': 'परिचय फिर से देखें',

  // ── Review completion celebration ──────────────────────────────────
  'Session Completed': 'सत्र पूरा हुआ',
