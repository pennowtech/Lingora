...
/**
 * Android's "Process Text" intent — the entry Lingora adds to the system text-selection toolbar
 * (long-press a word in any app -> a "Search in Lingora" option appears next to Copy/Web search).
