# Lemmory Help & Feature Documentation
...
Below is the complete, concise list of all supported screens and features across the Lemmory platform. Each section links to its dedicated, in-depth guide covering what it is, how to use it, why it works, and troubleshooting tips.
...
- **[Settings & Configuration Guide](09-settings-engines.md)**
  ...
  - **Library & Content**: Anki (`.apkg`) and CSV/Spreadsheet visual import wizards, Lemmory package (`.lem`) backups, Liquid card template designer, and offline dictionary packs.
