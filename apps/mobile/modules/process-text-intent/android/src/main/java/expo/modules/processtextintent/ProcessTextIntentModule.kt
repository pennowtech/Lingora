...
/**
 * Bridges Android's "Process Text" intent — the entry Lemony adds to the system text-selection
 * toolbar (long-press a word in any app -> "Search in Lemony") — into JS. See
 ...
 *  - Cold start (Lemony wasn't running): MainActivity's own `onCreate` receives it, captured by
