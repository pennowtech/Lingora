 ...
 *
 * Not exported from the package barrel — tests import it directly. (Mirrors
 * packages/ai/src/testing/node-sqlite-adapter.ts, which can't be reused here
 * directly since that package depends on this one, not the other way round.)
 */
