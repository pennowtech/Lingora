...
'Search a {{target}} word': 'Ein {{target}}es Wort suchen',
  'Look up any {{target}} word and Lingora turns it into a flashcard with meanings, examples, and pronunciation.': 'Schlage ein beliebiges {{target}}es Wort nach, und Lemmory erstellt daraus eine Karteikarte mit Bedeutungen, Beispielen und Aussprache.',
  ...
  'Anki (.apkg), CSV spreadsheet, Lingora backup': 'Anki (.apkg), CSV-Tabelle, Lemmory-Sicherung',
  ...
  'Welcome to Lemmory': 'Willkommen bei Lemmory',
  ...
  "What's Fresh in Lemmory": 'Neu in Lemmory',
  ...
  'Long-press a word in any app - your browser, messages, anywhere - and pick **"Search in Lemmory."** It opens right here with that word ready to go.': 'Halte ein Wort in einer beliebigen App gedrückt – im Browser, in Nachrichten oder anderswo – und wähle **„In Lemmory suchen“**. Das Wort wird hier direkt zur Suche geöffnet.',
  ...
  'Lemmory is built **offline-first**. All your cards, review history, and learning progress stay strictly on your device unless you enable optional Cloud Sync.': 'Lemmory ist **Offline-First** aufgebaut. Alle Karten, Wiederholungsverläufe und Lernfortschritte bleiben ausschließlich auf deinem Gerät, sofern du nicht die optionale Cloud-Synchronisierung aktivierst.',
  ...
  'Your feedback is delivered directly to the Lemmory engineering team to help improve the app, resolve issues, and build requested features.': 'Dein Feedback wird direkt an das Lemmory-Entwicklungsteam übermittelt, damit wir die App verbessern, Probleme lösen und gewünschte Funktionen entwickeln können.',
